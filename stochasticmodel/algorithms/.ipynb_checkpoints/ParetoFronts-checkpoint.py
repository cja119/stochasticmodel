...
class ParetoFront:
    ...
    @classmethod
    def plot_pareto_front(cls, filename, axis_labels=('Varied Parameter', 'Objective Value'), normaliser=(1, 1),times_time = False):
        folder = 'DataAnalysis'
        ...
        plt.plot(x_values, means, marker='o', linestyle='-', color='black', label='Mean')
        ...
        for ci in confidence_intervals:
            ...
            plt.fill_between(x_values, lower_bounds, upper_bounds, color='grey', alpha=(1 - ci) * 0.75, label=ci_label)
