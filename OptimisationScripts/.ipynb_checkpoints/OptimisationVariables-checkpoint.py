...
def generate_variables(model):
    ...
    model.energy_electrolysers = Var(model.full_set, model.electrolysers, within=NonNegativeReals)
    ...
    model.energy_gh2_use = Var(model.full_set, model.vectors, within=NonNegativeReals)
    model.energy_gh2_rem = Var(model.full_set, model.vectors, within=NonNegativeReals)
    ...
    model.vector_storage_origin = Var(model.full_set, model.vectors, within=NonNegativeReals)
    ...
    model.number_ships_charging = Var(model.full_set, model.vectors, within=NonNegativeReals)
    ...
    model.capacity_vector_storage_origin       = Var(model.vectors, within=NonNegativeReals)
    model.capacity_electrolysers               = Var(model.electrolysers,within=NonNegativeReals)
